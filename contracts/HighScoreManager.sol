...
contract HighScoreManager {
    ...
    event NewWinAdded(address _for, uint totalWins);
    ...
    function addWin(address _for) public onlyGameManager {
        ...
        while (count <= 10) {
            ...
            if (highscoreMapping[currentPosition].numberOfWins <= highscoreMapping[_for].numberOfWins 
                && currentPosition != _for) {
